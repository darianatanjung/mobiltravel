      ...
      <div class="col-sm-6">
        <form class="row g-3 mt-4" action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('merek') is-invalid @enderror" name="merek" id="merek" value="{{ $golongan->merek }}" placeholder="Mobil">
            @error('merek')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('warna') is-invalid @enderror" name="warna" id="warna" value="{{ $golongan->warna }}" placeholder="Warna">
            @error('warna')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
